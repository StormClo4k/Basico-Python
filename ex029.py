...
kmh = int(input('Digite a velocidade do seu veiculo: '))

if kmh <= 80:
    print('Muito bem! Voce esta dentro do limmite de velocidade')
else:
    print('Voce foi multado! O valor da multa é de R${}'.format((kmh - 80) * 7))
